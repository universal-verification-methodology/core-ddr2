...
The detailed architecture is specified in `docs/DDR2.md`, and the verification and simulation flow is described in `test/TESTING.md`; UVM-based verification is documented in `test-uvm/README_UVM.md`. This `README` provides a practical overview and entry point.
...
For a full block‑level and state‑machine description, see `docs/DDR2.md`.
...
- `docs/` – project documentation: `DDR2.md` (architecture and protocol specification), JEDEC JESD79-2 reference, etc.
...
Address mapping, timing and protocol details are documented in `docs/DDR2.md`.
...
- Bug fixes or clarifications in `docs/DDR2.md`, `test/TESTING.md`, and `test-uvm/README_UVM.md`.
